tinymce.addI18n('az', {
  ...
  "Code view": "Kod görünüşü",
  "Color Picker": "Rəng seçici",
  "Color swatch": "Rəng nümunəsi",
  "Cols": "Sütunlar",
  "Column": "Sütun",
  "Column clipboard actions": "Sütun mübadilə buferi hərəkətləri",
  "Column group": "Sütunun qrupu",
  "Column header": "Sütun başlığı",
  ...
  "Could not load emojis": "Emoji yükləmək mümkün olmadı",
  "Count": "Say",
  "Currency": "Valyuta",
  ...
  "Dropped file type is not supported": "Seçilmiş fayl növü dəstəklənmir",
  "Edit": "Redaktə et",
  "Embed": "Əlavə etmək üçün kod",
  "Emojis": "Emoji",
  "Emojis...": "Emojilər...",
  "Error": "Xəta",
  "Error: Form submit field collision.": "Xəta: Forma göndərmə sahəsində toqquşma.",
  "Error: No form element found.": "Xəta: Heç bir forma elementi tapılmadı.",
  ...
  "Image...": "Şəkil",
  "ImageProxy HTTP error: Could not find Image Proxy": "ImageProxy HTTP xətası: Şəkil Proksisini tapmaq mümkün olmadı",
  ...
  "Link...": "Bağlantı",
  "List Properties": "Siyahı xüsusiyyətləri",
  "List properties...": "Siyahı xüsusiyyətləri...",
  "Loading emojis...": "Emojilər yüklənir...",
  "Loading...": "Yüklənir...",
  ...
  "Objects": "Əşyalar",
  "Ok": "Oldu",
  "Open help dialog": "Kömək pəncərəsini aç",
  "Open link": "Keçidi aç",
  "Open link in...": "Bağlantıyı açın",
  "Open popup menu for split buttons": "Bölmə düymələri üçün açılan menyunu açın",
  "Orange": "Narıncı",
  "Outset": "",
  ...
  "Paste column after": "Sütundan sonra yapışdır",
  "Paste column before": "Sütundan əvvəl yapışdır",
  ...
  "Row": "Sətir",
  "Row clipboard actions": "Sətir mübadilə buferi hərəkətləri",
  ...
  "Switch to or from fullscreen mode": "Tam ekran rejimin keçin və ya çıxın",
  "Symbols": "Simvollar",
  ...
  "turkish lira sign": "türkiyə lirəsi simvolu",
