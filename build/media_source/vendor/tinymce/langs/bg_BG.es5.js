tinymce.addI18n('bg-BG', {
  ...
  "Cell styles": "Стилова на клетката",
  ...
  "Cols": "Колони",
  "Column": "Колона",
  "Column clipboard actions": "Действия на клипборда за колоната",
  "Column group": "Група колони",
  "Column header": "Хедър на колона",
  ...
  "Could not load emojis": "Грешка при зареждане на емоджита",
  "Count": "Брой",
  "Currency": "Валута",
  ...
  "Dropped file type is not supported": "Типа на поставеният файл не се поддържа",
  "Edit": "Редактиране",
  "Embed": "Вграждане",
  "Emojis": "Емотикони",
  "Emojis...": "Емотикони...",
  ...
  "Find in selection": "Намери в селектираният фрагмент",
  ...
  "Height": "Височина",
  "Help": "Помощ",
  "Hex color code": "Шестнадесетичен код на цвета",
  "Hidden": "Скрит",
  "Horizontal align": "Хирозонтално подравняване",
  "Horizontal line": "Хоризонтална черта",
  "Horizontal space": "Хоризонтално пространство",
  "ID": "ID",
  "ID should start with a letter, followed only by letters, numbers, dashes, dots, colons or underscores.": "ID-то трябва да започва с буква, последвано само от букви, цифри, тирета, точки, точка и запетая и долни черти.",
  "Image is decorative": "Изображението е декоративно",
  "Image list": "Списък с изображения",
  "Image title": "Заглавие на изображението",
  "Image...": "Изображение...",
  "ImageProxy HTTP error: Could not find Image Proxy": "ImageProxy HTTP грешка: Не може да намери Image Proxy",
  "ImageProxy HTTP error: Incorrect Image Proxy URL": "ImageProxy HTTP грешка: Невалидно Image Proxy URL",
  "ImageProxy HTTP error: Rejected request": "ImageProxy HTTP грешка: Отхвърлена заявка",
  "ImageProxy HTTP error: Unknown ImageProxy error": "ImageProxy HTTP грешка: Непозната ImageProxy грешка",
  "Increase indent": "Увеличаване на отстъпа",
  "Inline": "На един ред",
  "Insert": "Вмъкване",
  "Insert Template": "Добави шаблон",
  "Insert accordion": "",
  ...
  "Inset": "Вътрешен",
  "Invalid hex color code: {0}": "Невалиден шестнадесетичен (HEX) код на цвят: {0}",
  ...
  "Link...": "Хипервръзка...",
  "List Properties": "Списък с реквизити",
  "List properties...": "Списък с реквизити...",
  ...
  "Open popup menu for split buttons": "Отвори поп-ъп менюто за разделените бутони",
  "Orange": "Оранжево",
  "Outset": "Външен",
  ...
  "Paste column after": "Постави колоната след",
  "Paste column before": "Постави колоната преди",
  ...
  "Rich Text Area": "Област с обогатен текст",
  ...
  "Row": "Ред",
  "Row clipboard actions": "Действия на клипборда за реда",
  "Row group": "Група редове",
  "Row header": "Хедър на ред",
  ...
  "Start list at number": "Започни списъка от номер",
  ...
  "Table": "Таблица",
  "Table caption": "Надпис на таблица",
  ...
  "The URL you entered seems to be an external link. Do you want to add the required https:// prefix?": "Въведеният URL адрес е външен линк. Искате ли да се добави задължителният https:// префикс?",
  "Title": "Наименование",
