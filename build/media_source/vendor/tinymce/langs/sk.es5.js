tinymce.addI18n('sk', {
  ...
  "Image...": "Obrázok...",
  "ImageProxy HTTP error: Could not find Image Proxy": "ImageProxy HTTP chyba: Nebolo nájdené Image Proxy",
  "ImageProxy HTTP error: Incorrect Image Proxy URL": "ImageProxy HTTP chyba: Chybná Image Proxy URL adresa",
  "ImageProxy HTTP error: Rejected request": "ImageProxy HTTP chyba: Odmietnutá požiadavka",
  "ImageProxy HTTP error: Unknown ImageProxy error": "ImageProxy HTTP chyba: Neznáma ImageProxy chyba",
  ...
  "Open popup menu for split buttons": "Otvorte vyskakovacie menu pre rozdelené tlačidlá",
  "Orange": "Oranžová",
  "Outset": "Vystúpené",
